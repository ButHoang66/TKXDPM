...
public class ListStationHandler extends BaseScreenHandler implements Initializable {
    ...
    private ListStationDao dao;

    public ListStationHandler() {

    }

    public ListStationHandler(Stage stage, String screenPath) throws IOException {
        super(stage, screenPath);
        dao = new ListStationImpl();
    }
    ...
    private void setListStation() throws SQLException {
        List<BikeStation> stationList = dao.getAll();
